...
<body>
	...
	<div class="charts clearfix">
		<div class="selector">
			...
			<div class="checkbox"><input type="checkbox" name="age-79" id="age-79"><label for="age-79">70-79 ans</label></div>
			<div class="checkbox"><input type="checkbox" name="age-89" id="age-89" checked="checked"><label for="age-89">80-89 ans</label></div>
			<div class="checkbox"><input type="checkbox" name="age-90" id="age-90"><label for="age-90">90+ ans</label></div>
		</div>
